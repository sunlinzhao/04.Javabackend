    ...
    <form action="RoomTypeServlet?flag=update" method="post">
        <div class="form-group">
            ...
            <input type="text" name="type"
                   class="form-control" id="type" value="${roomType.type}" placeholder="请填写房间类型">
        </div>
        <div class="form-group">
            <label for="price">房型单价</label>
            <input type="number" class="form-control" id="price"
                   placeholder="请填写房型单价" value="${roomType.price}" name="price">
        </div>
        <div class="form-group">
            <label for="deposit">房型押金</label>
            <input type="number" class="form-control" id="deposit"
                   placeholder="请填写房型押金"  value="${roomType.deposit}" name="deposit">
        </div>
        <div class="form-group">
            <label for="bedNum">床位数量</label>
            <input type="number" class="form-control" id="bedNum" name="bedNum"
                   placeholder="请填写床位数量"  value="${roomType.bedNum}">
        </div>
        <div class="form-group">
            <label for="remark">房型备注</label>
            <textarea id="remark" class="form-control" name="remark">${roomType.remark}</textarea>
        </div>
